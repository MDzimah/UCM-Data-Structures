...
// a = 2, b = 2, d = 0 (en el caso peor si está equilibrado) --> Th. División, como a = 1 = b^d = 1, el algoritmo tiene coste O(n^d log n) = O(log n)
//En el caso del árbol degenerado tiene coste lineal en el número de nodos puesto que se visitan todos 1 vez en el caso peor
template<typename T>
